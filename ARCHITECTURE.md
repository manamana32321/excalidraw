...
### URLs
- **Web UI**: `https://excalidraw.example.com/`
- **Files**: `https://excalidraw.example.com/files/`
- **File Access**: `https://excalidraw.example.com/files/myfile.excalidraw`
- **Socket**: `wss://excalidraw.example.com/socket` (if enabled)

### DNS Configuration
```
excalidraw.example.com  →  A Record  →  <Ingress IP>
```
